      ...
      <AnimatePresence mode="popLayout">
        {hoveredIndex === tech.id && (
          <motion.div
            ...
            className="absolute -top-16 -left-1/2 translate-x-1/2 flex text-xs  flex-col items-center justify-center rounded-md bg-white z-50 shadow-xl px-1 py-2"
          >
            ...
            <div className="font-bold text-black relative z-30 text-base">{tech.name}</div>
